...
export const texts = {
    ON_DELETING_QUESTION: "¿Desea anular la transaction?",
    ON_GOAL_DELETING_QUESTION: "¿Desea borrar la meta?",
    ON_DELETING_WARN: "Al confirmar se anula la transacción definitivamente",
    ON_GOAL_DELETING_WARN: "Al confirmar se elimina la meta definitivamente",
    ...
    WITH_NO_TRANSACTIONS: "Informacion de saldos no disponible. Comience a crear transactions...",
    ...
    ON_COMPLETED_GOAL: "Meta completed!",
    ON_WITHDRAWN_GOAL: "Meta withdrawn con éxito!",
    INCOMES: "incomes",
    EXPENSES: "expenses"
};
